...
### 🎟 대규모 트래픽 방지 예매 서비스  
- 전체 클라우드 아키텍처 설계  
- Multi-Region DR(Disaster Recovery) 구성 및 자동 Failover 설계  
- Global Accelerator, ALB, EKS 기반 아키텍처 구축  
🔗 https://github.com/cloudwave-CGV/cloudwave-CGV  

---

### 📰 Serverless News App  
- AWS Lambda, API Gateway 기반 서버리스 구조 설계  
- DynamoDB, EventBridge 활용 뉴스 수집 자동화  
...
- Ansible을 활용한 서버 프로비저닝 자동화  
🔗 https://github.com/whdbtjd/Iac-auto-deploy  
